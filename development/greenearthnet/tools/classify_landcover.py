...
def sort_tile(root, tile):
    ...
    forest_folder = r"E:\DZ\forest_dominated\train"
    forest_folder += "\\" + tile
    cropland_folder = r"E:\DZ\crop_dominated\train"
    cropland_folder += "\\" + tile
    shrub_grass_folder = r"E:\DZ\shrub_dominated\train"
    shrub_grass_folder += "\\" + tile
...
def sort_test_data(input_folder):
    forest_folder = r"E:\DZ\forest_dominated\ood-t_chopped"
    cropland_folder = r"E:\DZ\crop_dominated\ood-t_chopped"
    shrub_grass_folder = r"E:\DZ\shrub_dominated\ood-t_chopped"
    ...
    print("Done classifying files in ood-t_chopped")


if __name__ == "__main__":
    # base_dir = r"E:\DZ\greenearthnet\train"
    # base_dir = r"E:\DZ\greenearthnet\val_chopped"
    # for root, dirs, files in os.walk(base_dir):
        # for dir in dirs:
            # print("classifying files in tile: ", dir)
            # sort_tile(root, dir)
    base_dir = r"E:\DZ\greenearthnet\ood-t_chopped\MJJ21"
    sort_test_data(base_dir)