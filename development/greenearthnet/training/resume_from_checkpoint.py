...
def train_model(setting_dict: dict, setting_file: str = None, checkpoint_path = None):
    start = time.time()
    ...
    trainer_dict["accelerator"] = "cpu"
    # trainer_dict["devices"] = 1
    trainer_dict["strategy"] = "single_device"
    ...
    # trainer.fit(task, dm)
    trainer.fit(task, dm, ckpt_path=checkpoint_path)
...
if __name__ == "__main__":
    ...
    train_model(setting_dict, args.setting, checkpoint_path=args.resume)
