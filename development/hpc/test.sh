...
#SBATCH --job-name=4_gpu_GEN_train      
...
python ./train.py config/seed=42.yaml --data_dir /gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/greenearthnet_data/single_site
