...
#SBATCH --job-name=F_4_gpu_GEN_train      
...
python ./train.py config/4_gpu/seed=42.yaml --data_dir /gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/greenearthnet_data/forest_dominated
