...
srun --nodes=1 --ntasks=1 --output=/gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/fork/development/hpc/training_batches/shrub/hpc_logs/%x-%j-31TBF.out --error=/gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/fork/development/hpc/training_batches/shrub/hpc_logs/%x-%j-31TBF.err bash -c 'echo "Running site 31TBF on $(hostname)"; python ./test.py' &
srun --nodes=1 --ntasks=1 --output=/gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/fork/development/hpc/training_batches/shrub/hpc_logs/%x-%j-32TML.out --error=/gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/fork/development/hpc/training_batches/shrub/hpc_logs/%x-%j-32TML.err bash -c 'echo "Running site 32TML on $(hostname)"; python ./t.py' &


# srun --exclusive --nodes=1 --ntasks=1 --output=/gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/fork/development/hpc/training_batches/shrub/hpc_logs/%x-%j-31TBF.out --error=/gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/fork/development/hpc/training_batches/shrub/hpc_logs/%x-%j-31TBF.err bash -c 'echo "Running site 31TBF on $(hostname)"; python ./train.py /gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/fork/development/hpc/config/4_gpu/seed=42.yaml --data_dir /gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/greenearthnet_data/shrub_sites/31TBF' &

# srun --exclusive --nodes=1 --ntasks=1 --output=/gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/fork/development/hpc/training_batches/shrub/hpc_logs/%x-%j-32TML.out --error=/gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/fork/development/hpc/training_batches/shrub/hpc_logs/%x-%j-32TML.err bash -c 'echo "Running site 32TML on $(hostname)"; python ./train.py /gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/fork/development/hpc/config/4_gpu/seed=42.yaml --data_dir /gpfs/fs5/nrcan/nrcan_geobase/work/doz000/projects/greenearthnet_data/shrub_sites/32TML' &
